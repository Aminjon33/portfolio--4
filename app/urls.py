...
urlpatterns = [
    ...
    path('coming_soon/',coming_soon_view,name='coming_soon-page'),
    ...
    path('wishlist.html/',wishlist_view,name='wishlist.html-page'),
